...
names(mydat)[
  which(names(mydat) %in% 
          c(country_var_name,latitude_var_name,longitude_var_name,
            year_var_name,N_var_name,indicator_var_name))] <- c('country','latitude','longitude',
                                                                'year','N','indi')
if (prop_present) {
