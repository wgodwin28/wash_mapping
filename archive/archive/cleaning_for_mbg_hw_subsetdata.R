...
for (shp in unique(data_poly$shapefile)) {
  ...
  save(subset, file = paste0("J:/WORK/11_geospatial/wash/resampling/1.30.17/hw/sdg/subset_",shp,".RData"))
 }

save(data_poly, file = "J:/WORK/11_geospatial/wash/resampling/1.30.17/hw/sdg/master_poly.RData")
save(hh_vector, file = "J:/WORK/11_geospatial/wash/resampling/1.30.17/hw/sdg/hh_vector.RData")